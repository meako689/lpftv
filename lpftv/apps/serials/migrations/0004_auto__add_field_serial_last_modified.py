...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Serial.last_modified'
        db.add_column('serials_serial', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 12, 6), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Serial.last_modified'
        db.delete_column('serials_serial', 'last_modified')
